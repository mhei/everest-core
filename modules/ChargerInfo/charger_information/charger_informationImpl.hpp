...
#ifndef CHARGER_INFORMATION_CHARGER_INFORMATION_IMPL_HPP
#define CHARGER_INFORMATION_CHARGER_INFORMATION_IMPL_HPP
...
public:
    ...
    charger_informationImpl(Everest::ModuleAdapter* ev, const Everest::PtrContainer<ChargerInfo>& mod, Conf& config) :
        charger_informationImplBase(ev, "charger_information"), mod(mod), config(config){};
...
#endif // CHARGER_INFORMATION_CHARGER_INFORMATION_IMPL_HPP
